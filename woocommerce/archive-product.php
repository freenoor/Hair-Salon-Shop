...
<div class="background_home" style="background-image: url(<?= get_site_url();?>/wp-content/uploads/2019/12/IMAGE-HERE5s.png);">
    <div class="welcome_div">
		<div class="justforborder">
			<div class="content_home">
				...
				<a href="<?php the_field('link_shop');?>">Weiterlesen</a>
			</div>
		</div>
    </div>
</div>
